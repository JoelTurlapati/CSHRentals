...
class CshPortfolioHighend extends HTMLElement {
  connectedCallback() {
    ...
    var PORTFOLIO = 'Portfolio 5 — High End Rent Portfolio';
    var PROPERTIES = [
      {
        ...
        photos: ['https://static.wixstatic.com/media/d9828b_d87f143bc3574c599e9a94c33a08f68f~mv2.jpg']
      },
      {
    ...
    var RENTS = {'225 Grandview Ave NW':'$1,600','244 Harter Ave NW':'$1,640','300 Montrose Ave NW':'$2,330','1103 22nd St NW':'$1,850','2631 Demington Ave NW':'$2,100'};
  ...
  <div class="prop-card__body">
    ...
    <div class="prop-card__meta">${p.beds} bd &nbsp;&middot;&nbsp; ${p.baths} ba${rent ? ' &nbsp;&middot;&nbsp; ' + rent + '/mo' : ''}</div>
  </div>
</div>`;
    }).join('');
...
<section class="hero">
  <div class="hero__badge">Portfolio 5 &mdash; High End</div>
  <h1 class="hero__title">Portfolio 5: High End Rent Portfolio</h1>
  <p class="hero__sub">5 premium rental homes &nbsp;&middot;&nbsp; Canton, OH</p>
</section>
<div class="section-head"><h2>Properties</h2><span>5 homes &middot; $9,520/mo &middot; $114,240 Annual</span></div>
