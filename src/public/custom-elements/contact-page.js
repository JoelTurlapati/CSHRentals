...
/* ── HERO ── */
.cp-hero{background:linear-gradient(135deg,#0a1628,#0d2545);padding:52px 32px 56px;text-align:center}
.cp-hero__eyebrow{display:inline-block;font-size:12px;font-weight:700;letter-spacing:.25em;text-transform:uppercase;color:#c8962a;border:1px solid rgba(200,150,42,.35);padding:5px 16px;border-radius:20px;margin-bottom:18px}
...
/* ── FORM SECTION ── */
.cp-form-section{max-width:680px;margin:0 auto;padding:44px 24px 56px}
.cp-form-card{background:#fff;border-radius:14px;padding:34px 32px;box-shadow:0 4px 32px rgba(10,30,60,.1)}
.cp-form-card h2{font-size:26px;font-weight:800;color:#0d1f35;margin-bottom:6px}
.cp-form-card p{font-size:17px;color:#5a6b85;margin-bottom:18px}
...
.cp-disclaimer{margin-top:12px;font-size:14px;color:#8899bb;line-height:1.5;text-align:center}

/* ── INFO STRIP ── */
.cp-info{background:#fff;border-top:1px solid rgba(10,30,60,.08);padding:40px 32px}
...
.cp-info__sub{font-size:17px;color:#5a6b85;text-align:center;margin-bottom:28px}
...
.cp-step p{font-size:16px;color:#5a6b85;line-height:1.55}
