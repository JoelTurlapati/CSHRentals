...
.csh-hdr__btn{padding:9px 18px;font-size:11px;font-weight:700;letter-spacing:.07em;text-transform:uppercase;border-radius:6px;text-decoration:none;border:1.5px solid rgba(255,255,255,.3);color:rgba(255,255,255,.85);transition:background .2s;white-space:nowrap}
...
.csh-hdr__email{width:36px;height:36px;border-radius:50%;border:1.5px solid rgba(255,255,255,.3);color:rgba(255,255,255,.85);display:flex;align-items:center;justify-content:center;text-decoration:none;font-size:15px;transition:background .2s}
...
.cp-hero__eyebrow{display:inline-block;font-size:10px;font-weight:700;letter-spacing:.25em;text-transform:uppercase;color:#c8962a;border:1px solid rgba(200,150,42,.35);padding:5px 16px;border-radius:20px;margin-bottom:24px}
.cp-hero__h1{font-size:clamp(26px,4vw,44px);font-weight:900;color:#fff;line-height:1.1;letter-spacing:-.02em;margin-bottom:14px}
.cp-hero__sub{font-size:15px;color:rgba(255,255,255,.65);max-width:560px;margin:0 auto}
...
.cp-form-card h2{font-size:22px;font-weight:800;color:#0d1f35;margin-bottom:6px}
.cp-form-card p{font-size:14px;color:#5a6b85;margin-bottom:28px}
.form-row{display:grid;grid-template-columns:1fr 1fr;gap:16px}
@media(max-width:540px){.form-row{grid-template-columns:1fr}}
.form-group{margin-bottom:18px}
.form-group label{display:block;margin-bottom:6px;font-size:11.5px;font-weight:700;color:#0d1f35;text-transform:uppercase;letter-spacing:.07em}
.form-group input,.form-group textarea,.form-group select{width:100%;padding:12px 16px;border:1.5px solid #d8e0e8;border-radius:7px;font-size:14px;font-family:'Inter',sans-serif;color:#0d1f35;background:#fff;transition:border-color .2s,box-shadow .2s;resize:vertical}
...
.cp-submit{width:100%;padding:15px;background:#c8962a;color:#0a1628;font-family:'Inter',sans-serif;font-size:13px;font-weight:800;letter-spacing:.08em;text-transform:uppercase;border:none;border-radius:7px;cursor:pointer;transition:background .2s;margin-top:6px}
.cp-submit:hover{background:#dba83a}
.cp-submit:disabled{background:#8899bb;cursor:not-allowed}
.cp-disclaimer{margin-top:16px;font-size:12px;color:#8899bb;line-height:1.7;text-align:center}
...
.cp-info__h2{font-size:clamp(20px,3vw,30px);font-weight:800;color:#0d1f35;text-align:center;margin-bottom:10px}
.cp-info__sub{font-size:14px;color:#5a6b85;text-align:center;margin-bottom:48px}
...
.cp-step h3{font-size:15px;font-weight:800;color:#0d1f35;margin-bottom:10px}
.cp-step p{font-size:13px;color:#5a6b85;line-height:1.75}
...
.cp-detail-item__lbl{font-size:10px;font-weight:700;letter-spacing:.2em;text-transform:uppercase;color:rgba(255,255,255,.4);margin-bottom:6px}
.cp-detail-item__val{font-size:15px;font-weight:600;color:#fff;text-decoration:none}
a.cp-detail-item__val:hover{color:#c8962a}

/* ── FOOTER ── */
.footer{background:#060e1c;padding:22px 32px;text-align:center;font-size:11.5px;color:rgba(255,255,255,.3)}
</style>
